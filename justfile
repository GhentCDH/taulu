...
setup-no-rerun:
    maturin develop --no-default-features --release

setup-rerun:
    maturin develop --features debug-tools --no-default-features --release

setup-rerun-dev:
    maturin develop --features debug-tools --no-default-features
